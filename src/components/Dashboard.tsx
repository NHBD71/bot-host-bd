    ...
    <div className="min-h-screen bg-[#0b0f19] text-gray-100 flex flex-col justify-between selection:bg-emerald-500 selection:text-black">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden border-b border-white/5 bg-[#05080e]/95 backdrop-blur-lg px-4 py-4 space-y-3 z-30 transition-all shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <HelpCircle className="w-4 h-4" /> Help Care
            </button>
            <button 
      ...
      {isProfileModalOpen && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-[#0a1120] border border-white/10 rounded-2xl overflow-hidden shadow-2xl animate-fade-in text-gray-100">
            {/* Modal Header */}
            <div className="p-5 border-b border-white/5 bg-[#080d16] flex justify-between items-center">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center">
                  <User className="w-4 h-4 text-emerald-400" />
                </div>
            ...
            {/* Modal Actions */}
            <div className="p-4 bg-[#080d16] border-t border-white/5 flex justify-end">
              <button 
                onClick={() => setIsProfileModalOpen(false)}
                className="w-full px-5 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-semibold text-xs uppercase rounded-xl cursor-pointer transition shadow-[0_4px_12px_rgba(16,185,129,0.15)] text-center font-display"
              >
                Close Profile
              </button>
            </div>
