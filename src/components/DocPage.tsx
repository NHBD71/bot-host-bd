    ...
    <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-8">
      ...
      <div className="p-6 rounded-2xl bg-indigo-500/5 border border-indigo-500/10 space-y-3">
        <h3 className="text-xs font-mono font-bold text-indigo-400 uppercase tracking-widest flex items-center gap-2">
          ...
          Render Keep-Alive & Anti-Sleep Guide
        </h3>
        <p className="text-xs text-gray-300 leading-relaxed">
          Render's free tier automatically puts your app to sleep (spin-down) after <strong>15 minutes</strong> of inactivity. When it sleeps, your Telegram bot won't respond until the website is visited again.
        </p>
        <div className="space-y-2 text-xs text-gray-400 leading-relaxed">
          <p>
            <strong className="text-indigo-400">1. Built-in Auto-Ping:</strong> Our server has an automatic self-ping feature. To active it, ensure your Render Web Service dashboard has the environment variable <code className="bg-white/5 text-emerald-400 px-1 py-0.5 rounded font-mono">RENDER_EXTERNAL_URL</code> defined (Render creates this automatically!). Our server will automatically ping itself every 5 minutes to keep your bot active 24/7.
          </p>
          <p>
            <strong className="text-indigo-400">2. External Cron (Highly Recommended backup):</strong> If you want absolute 100% reliability, copy your Render URL (e.g., <code className="bg-white/5 text-gray-300 px-1 py-0.5 rounded font-mono">https://your-app.onrender.com</code>) and add it to a free monitoring service like <a href="https://uptimerobot.com" target="_blank" rel="noreferrer" className="text-emerald-400 underline hover:text-emerald-300">UptimeRobot.com</a> or <a href="https://cron-job.org" target="_blank" rel="noreferrer" className="text-emerald-400 underline hover:text-emerald-300">Cron-Job.org</a>. Set it to ping your app URL or <code className="bg-white/5 text-gray-300 px-1 py-0.5 rounded font-mono">/api/health</code> every 5-10 minutes, ensuring it never goes to sleep!
          </p>
        </div>
      </div>
    </div>
